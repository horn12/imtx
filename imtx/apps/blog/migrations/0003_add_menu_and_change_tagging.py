...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_menu', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Post'], null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Menu'], null=True, blank=True)),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('blog', ['Menu'])

        # Changing field 'Post.tag'
        db.alter_column('blog_post', 'tag', self.gf('tagging.fields.TagField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.tag'
        db.alter_column('blog_post', 'tag', self.gf('TagField')())
