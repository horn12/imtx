...
from imtx.apps.blog.models import *

class Migration:
    
    def forwards(self, orm):
        
        # Adding field 'Media.watermarked'
        db.add_column('blog_media', 'watermarked', orm['blog.media:watermarked'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Media.watermarked'
        db.delete_column('blog_media', 'watermarked')
