...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('blog_post', 'slug', self.gf('django.db.models.fields.SlugField')(blank=True, unique=True, max_length=50, null=True, db_index=True), keep_default=False)
    ...
    models = {
        ...
        'blog.menu': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Post']", 'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Menu']", 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
