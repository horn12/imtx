...
from models import Post, Page, Category, Favourite
from imtx_cn.pagination.utils import get_page
#from imtx_cn.comments.models import Comment
#from imtx_cn.tagging.models import Tag, TaggedItem
from imtx_cn.comments.views import get_comment_cookie_meta
...
def single_favourite(request, id):
